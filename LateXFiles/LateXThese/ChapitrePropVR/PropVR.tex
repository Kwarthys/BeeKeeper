...
\label{ChapitrePropVR}
	...
	\section{Interactions au Clavier et à la Souris}
		...
		L'utilisateur peut éloigner ou rapprocher le cadre de sa caméra grâce à la molette de sa souris. Il peut aussi le faire pivoter sur ses 3 axes à l'aide de 6 touches de clavier, deux touches par axe, une négative et une positive. Par exemple, une touche permet de faire pivoter le cadre autour de son axe vertical vers la gauche, et une autre sur le même axe mais vers la droite. De cette manière l'utilisateur peut observer avec attention le contenu du cadre.
